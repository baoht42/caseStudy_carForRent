document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('selectedLocation').textContent = 'Selected Location: ' + selectedLocation;
...
function displayRentalDetails(selectedLocation) {
    ...
    if (selectedLocation === 'Đà Nẵng') {
        ...
        document.getElementById('carPrice').textContent = 'Price: $50 per day';
        document.getElementById('contactInfo').textContent = 'Contact: 123-456-7890';
    } else if (selectedLocation === 'Sài Gòn') {
        document.getElementById('carImage').src = 'css/image/car2.jpg';
        document.getElementById('carPrice').textContent = 'Price: $60 per day';
        document.getElementById('contactInfo').textContent = 'Contact: 987-654-3210';
    } else if (selectedLocation === 'Hà Nội') {
        document.getElementById('carImage').src = 'css/image/car3.jpg';
        document.getElementById('carPrice').textContent = 'Price: $55 per day';
        document.getElementById('contactInfo').textContent = 'Contact: 111-222-3333';
    }else if (selectedLocation === 'Cần Thơ') {
        document.getElementById('carImage').src = 'css/image/car4.jpg';
        document.getElementById('carPrice').textContent = 'Price: $55 per day';
        document.getElementById('contactInfo').textContent = 'Contact: 000-111-1233';
    }else if (selectedLocation === 'Nha Trang') {
        document.getElementById('carImage').src = 'css/image/car5.jpg';
        document.getElementById('carPrice').textContent = 'Price: $55 per day';
        document.getElementById('contactInfo').textContent = 'Contact: 8109-2314-1231';
    }else if (selectedLocation === 'Sapa') {
        document.getElementById('carImage').src = 'css/image/car6.jpg';
        document.getElementById('carPrice').textContent = 'Price: $55 per day';
        document.getElementById('contactInfo').textContent = 'Contact: 0901-1241-124';
    }
...
function calculateTotal() {
    ...
    document.getElementById('totalPrice').textContent = 'Total Price: $' + selectedPrice;
}
